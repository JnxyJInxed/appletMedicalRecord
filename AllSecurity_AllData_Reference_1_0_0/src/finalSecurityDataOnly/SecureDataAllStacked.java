...
public class SecureDataAllStacked extends Applet{
//--CLA DAN INS-----------------------------------------------------------------------//
//--//DATA MANAGEMENT
	//--CLA
...
//--//MAIN METHOD APPLET (KONSTRUKTOR)
    private SecureDataAllStacked (byte[] bArray,short bOffset,byte bLength) {
    //--DATA MANAGEMENT-----------------------------------------------------------------------//
    //--//INISIASI DATA
        //--Inisiasi parameter
    	InisiasiStatField();
...
//--//REGISTER
    public static void install(byte[] bArray, short bOffset, byte bLength) {
        new SecureDataAllStacked(bArray, bOffset, bLength);
    } 
//--//SELECT
...
//--//FUNGSI UTAMA DATA TEXT (CRUD)
    ...
    try{
    	...
    	byte[] data_final = removePadfromData(bufferData);
...
//--//INISIASI PARAMETER
    ...
    public void InisiasiMinField(){       	
        ...
        /* 20: No. KTP (ID Number) - NIK                                       */ MIN_FIELD_DATA[20] = (short) 16;
        ...
        /* 13: Suhu                                                            */ MIN_FIELD_DINAMIS[13] = (short) 4;
    ...
    public void InisiasiMaxField(){
        ...
        /* 20: No. KTP (ID Number) - NIK                                       */ MAX_FIELD_DATA[20] = (short) 16;
        ...
        /* 13: Suhu                                                            */ MAX_FIELD_DINAMIS[13] = (short) 4;
...
//--//INISIASI DATA
    ...
    //--//DATA DIRI
    	...
    	for(short i=0; i<MAX_ITEM_DATADIRI; i++){
    		dataDiri[i] = new IsiDataTEXT();
        	dataDiri[i].setData(LenPadded(MAX_FIELD_DATA[i]));
    	}
...
//    	
//    	//Alergi
//    	dataStatis[0] = new IsiDataTEXT();
//		dataStatis[0].setData(LenPadded(MAX_FIELD_STATIS[0]));
//		
//		//Goldar
//		dataStatis[1] = new IsiDataTEXT();
//		dataStatis[1].setData(LenPadded(MAX_FIELD_STATIS[1]));
//		
//		//Riwayat Operasi
//		dataStatis[4] = new IsiDataTEXT();
//		dataStatis[4].setData(LenPadded(MAX_FIELD_STATIS[4]));
